...
Route::middleware('guest')->group(function () {
    ...
    // GET /login dan /register redirect ke landing (modal)
    Route::get('/login', fn() => redirect()->route('landing'))->name('login.page');
    Route::get('/register', fn() => redirect()->route('landing'))->name('register.page');
});
